...
# 校园网网账号
user1 = input("请输入校园网登录账号\n")
user = int(user1)
passwd1 = input("请输入校园网登陆密码\n")
passed = int(passwd1)
...
while (True):
    ...
    if title == '注销页':
        ...
        schoolWebLoginURL = schoolWebURL1 + '/drcom/login?callback=dr' + t + '&DDDDD=' + user + '&upass=' + passwd + '&0MKKey=123456&R1=0&R3=0&R6=0&para=00&v6ip=&_=' + t
